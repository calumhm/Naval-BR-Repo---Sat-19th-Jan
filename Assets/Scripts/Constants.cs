...
public static class Constants {
	...
	public static readonly float DEFAULTMAXSHIPSPEED = 24.0f;

	// When the game starts, a ship's turnspeed is DEFAULT...
	//  The highest it can get is MAXIMUM...
	public static readonly float MAXIMUMTURNSPEED = 120000.0f;
	public static readonly float DEFAULTTURNSPEED = 40000.0f;

	// When the game starts, a ship's acceleration is DEFAULT...
	//  The highest it can get is MAXIMUM...
	public static readonly float MAXIMUMSHIPACCELERATION = 550000.0f;
	public static readonly float DEFAULTSHIPACCELERATION = 80000.0f;
	...
	public static readonly float CRATETIMEOUT = 60.0f;
